...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_AmplifyBinaryImg.setGeometry(QtCore.QRect(507, 561, 75, 23))
        ...
        self.button_AmplifyOrImg.setGeometry(QtCore.QRect(9, 561, 75, 23))
        ...
        self.button_LessenOrImg.setGeometry(QtCore.QRect(115, 561, 75, 23))
        ...
        self.slider_BinaryThre.setGeometry(QtCore.QRect(115, 9, 250, 22))
        ...
        self.label_SingleThre.setGeometry(QtCore.QRect(9, 9, 72, 16))
        ...
        self.label_ThresholdValue.setGeometry(QtCore.QRect(421, 9, 18, 16))
        ...
        self.button_lessenBinaryImg.setGeometry(QtCore.QRect(613, 561, 75, 23))
        ...
        self.button_ThreCon.setGeometry(QtCore.QRect(507, 9, 75, 23))
        self.button_ThreCon.setObjectName("button_ThreCon")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(9, 8, 1001, 531))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_OrImg = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.horizontalLayout.addWidget(self.label_OrImg)
        self.line = QtWidgets.QFrame(self.layoutWidget)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout.addWidget(self.line)
        self.label_BinaryImg = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.horizontalLayout.addWidget(self.label_BinaryImg)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_OrImg.setText(_translate("MainWindow", "原图显示区域，请点击开始选择需要处理的图像"))
        self.label_BinaryImg.setText(_translate("MainWindow", "效果图"))
